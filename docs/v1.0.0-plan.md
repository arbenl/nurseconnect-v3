...
The current v1.0.0 program sequence is M0 through M8:
...
The next program slice is tracked by the roadmap reconciliation docs under
`docs/superpowers/specs/2026-04-24-roadmap-reconciliation-next-slice-design.md`.
