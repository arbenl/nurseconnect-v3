...
| `NC-E0-04` | `ready` | platform | Repo hygiene and generated artifact cleanup. | Generated artifacts are untracked/ignored; no Firebase source remains; docs-only gates use a deterministic lightweight path; model critique debate is available when warranted. |
